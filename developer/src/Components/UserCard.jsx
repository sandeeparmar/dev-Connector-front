...
const UserCard = ({ user }) => {
  ...
  //handling accepted and ignoring the profile
  ...
  Address, _id} = user ;
   ...
   return (
   <div className={`bg-base-500 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden max-w-sm mx-auto my-4`}>
      {/* Image Section */}
